...
public class Preprocessor {
     ...
     */
    public static void preprocessComments(String databaseName) throws JSONException {
     ...
     */
    public static void preprocessTweets(String databaseName) throws JSONException {
        mc = new MongoConnector("localhost", 27017, databaseName);
